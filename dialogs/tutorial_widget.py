...
class TutorialWidget(QDialog):
  ...
  VOCABULARY_EXPLANATION = (
    ...
    'υπάρχει κάποιο τυπογραφικό λάθος ή ακόμα και να διαγράψετε λέξεις αν '
    'πιστεύετε πως δεν αντιστοιχούν σε πραγματικές λέξεις.\n\nΤέλος, μπορείτε να '
    'επεξεργαστείτε το σύνολο των συγγενικών τους λέξεων, προσθέτωντας ή '
    'αφαιρώντας λέξεις σε αυτό.'
  )
