...
class TutorialWidget(QDialog):
  ...
  APPLICATION_INTRODUCTION = (
    ...
    'προκειμένου να εντοπίσει τις συγγενικές λέξεις των λέξεων που αναζητά ο χρήστης.'
  ...
  STUDENT_EXPLANATION = (
    ...
    'πατώντας το κουμπί "Επεξεργασία Μαθητών και Προφίλ" που βρίσκεται στο δεξί '
    'μέρος της εφαρμογής.'
  )
  ...
  SUBJECT_EXPLANATION = (
    'Κάθε προφίλ αποτελείται από πολλαπλά μαθήματα.\n\n'
  ...
  RESULT_EXPLANATION = (
    ...
    'του επιλεγμένου προφίλ εμφανίζονται χωρίς πλάισιο. Λέξεις τις οποίες '
    ...
    'προφίλ, παρουσιάζονται μέσα σε ένα μπλε πλαίσιο.'
  )

  VOCABULARY_EXPLANATION = (
    'Μπορείτε να επεξεργαστείτε το λεξιλόγιο των βιβλίων των τάξεων του '
    'Δημοτικού πατώντας το κουμπί "Επεξεργασία Λέξεων" που βρίσκεται στην πάνω '
    'δεξιά γωνία της εφαρμογής.\n\nΜπορείτε να προσθέσετε νέες λέξεις σε όποιο '
    'βιβλίο επιθυμείτε, να επεξεργαστείτε υπάρχουσες λέξεις σε περίπτωση που '
    'υπάρχει κάποιο τυπογραφικό λάθος ή ακόμα και να διαγράψετε λέξεις.\n\n'
    'Τέλος, μπορείτε να επεξεργαστείτε το σύνολο των συγγενικών τους λέξεων, '
    'προσθέτωντας ή αφαιρώντας λέξεις σε αυτό.'
  )

  TEXTS = [
    APPLICATION_INTRODUCTION, STUDENT_EXPLANATION, PROFILE_EXPLANATION,
    SUBJECT_EXPLANATION, RESULT_EXPLANATION, VOCABULARY_EXPLANATION
  ]
